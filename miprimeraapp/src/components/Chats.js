...
export const Chat = () => {
  ...
  const [roomImage, setRoomImage] = useState('https://www.batiburrillo.net/wp-content/uploads/2019/07/Ampliacio%CC%81n-de-imagen-en-li%CC%81nea-sin-perder-calidad.jpg')
...
function RegistroSoporte(){
  ...
  const Registro = async () => {
    ...
    await registro.add({
        uid:1,
        photoURL: "https://icons-for-free.com/iconfiles/png/512/support+icon-1320184269482295776.png",
        displayName: 'Soporte ✔',
  ...
  if (props.room != "messages") {
    ...
    return (<li id='general'>
      <div id='general' onClick={async (e) => {
        ...
        props.setRoomImage('https://www.batiburrillo.net/wp-content/uploads/2019/07/Ampliacio%CC%81n-de-imagen-en-li%CC%81nea-sin-perder-calidad.jpg')

      }}>
        <li id='general'>
          <div id='general' className="d-flex bd-highlight">
            <div id='general' className="img_cont">
              <img src="https://www.batiburrillo.net/wp-content/uploads/2019/07/Ampliacio%CC%81n-de-imagen-en-li%CC%81nea-sin-perder-calidad.jpg" id='general' className="rounded-circle user_img" />
    ...
    return (<li id='soporte'>
      <div id='soporte' onClick={async (e) => {
         ...
         firestore.collection('soporte').where('uid', "==", e.target.id).get().then((query) => {
           ...
           props.setRoomImage('https://icons-for-free.com/iconfiles/png/512/support+icon-1320184269482295776.png')
        ...
        <li id='soporte'>
          <div id='soporte' className="d-flex bd-highlight">
            <div id='soporte' className="img_cont">
              <img src="https://icons-for-free.com/iconfiles/png/512/support+icon-1320184269482295776.png" id='soporte' className="rounded-circle user_img" />
